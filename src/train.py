...
from algorithms.Initialization import make_agent
...
def main(args):
	...
	if args.wandb:
		...
		group=args.wandb_group, job_type=args.wandb_job, entity=args.wandb_ID)
	...
	for step in range(start_step, args.train_steps+1):
		if done:
			...
			L.log('train/success_rate', episode_success, step)
			if args.wandb:
				wandb.log({'train/episode_reward':episode_reward, \
				'train/success_rate':episode_success})
