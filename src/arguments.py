...
def parse_args():
	...
	parser.add_argument('--task_name', default='Grasp')
	parser.add_argument('--frame_stack', default=1, type=int)
	parser.add_argument('--episode_length', default=100, type=int) #50
	...
	parser.add_argument('--cameras', default=1, type=int) # 0: 3rd person, 1: 1st person, 2: both
	parser.add_argument('--observation_type', default='state+image', type=str)
	...
	parser.add_argument('--wandb_ID', default='jj22jjj3')
